...
static uint32_t display_on_gpio_table[] = {
	LCM_GPIO_CFG(PRIMOU_LCD_PCLK, 1),
	LCM_GPIO_CFG(PRIMOU_LCD_DE, 1),
	LCM_GPIO_CFG(PRIMOU_LCD_VSYNC, 1),
	LCM_GPIO_CFG(PRIMOU_LCD_HSYNC, 1),
	LCM_GPIO_CFG(PRIMOU_LCD_G2, 1),
	LCM_GPIO_CFG(PRIMOU_LCD_G3, 1),
	LCM_GPIO_CFG(PRIMOU_LCD_G4, 1),
	LCM_GPIO_CFG(PRIMOU_LCD_G5, 1),
	LCM_GPIO_CFG(PRIMOU_LCD_G6, 1),
	LCM_GPIO_CFG(PRIMOU_LCD_G7, 1),
	LCM_GPIO_CFG(PRIMOU_LCD_B3, 1),
	LCM_GPIO_CFG(PRIMOU_LCD_B4, 1),
	LCM_GPIO_CFG(PRIMOU_LCD_B5, 1),
	LCM_GPIO_CFG(PRIMOU_LCD_B6, 1),
	LCM_GPIO_CFG(PRIMOU_LCD_B7, 1),
	LCM_GPIO_CFG(PRIMOU_LCD_R3, 1),
	LCM_GPIO_CFG(PRIMOU_LCD_R4, 1),
	LCM_GPIO_CFG(PRIMOU_LCD_R5, 1),
	LCM_GPIO_CFG(PRIMOU_LCD_R6, 1),
	LCM_GPIO_CFG(PRIMOU_LCD_R7, 1),
};

static uint32_t display_off_gpio_table[] = {
	LCM_GPIO_CFG(PRIMOU_LCD_PCLK, 0),
	LCM_GPIO_CFG(PRIMOU_LCD_DE, 0),
	LCM_GPIO_CFG(PRIMOU_LCD_VSYNC, 0),
	LCM_GPIO_CFG(PRIMOU_LCD_HSYNC, 0),
	LCM_GPIO_CFG(PRIMOU_LCD_G2, 0),
	LCM_GPIO_CFG(PRIMOU_LCD_G3, 0),
	LCM_GPIO_CFG(PRIMOU_LCD_G4, 0),
	LCM_GPIO_CFG(PRIMOU_LCD_G5, 0),
	LCM_GPIO_CFG(PRIMOU_LCD_G6, 0),
	LCM_GPIO_CFG(PRIMOU_LCD_G7, 0),
	LCM_GPIO_CFG(PRIMOU_LCD_B3, 0),
	LCM_GPIO_CFG(PRIMOU_LCD_B4, 0),
	LCM_GPIO_CFG(PRIMOU_LCD_B5, 0),
	LCM_GPIO_CFG(PRIMOU_LCD_B6, 0),
	LCM_GPIO_CFG(PRIMOU_LCD_B7, 0),
	LCM_GPIO_CFG(PRIMOU_LCD_R3, 0),
	LCM_GPIO_CFG(PRIMOU_LCD_R4, 0),
	LCM_GPIO_CFG(PRIMOU_LCD_R5, 0),
	LCM_GPIO_CFG(PRIMOU_LCD_R6, 0),
	LCM_GPIO_CFG(PRIMOU_LCD_R7, 0),
};
...
struct platform_device lcdc_primou_lg_panel_device = {
	.name   = "lcdc_primou_lg",
	.id     = 0,
	.dev    = {
...
struct msm_list_device primou_fb_devices[] = {
	{ "mdp", &mdp_pdata },
	{ "lcdc", &lcdc_pdata }
};
...
{
	if (!strcmp(name, "lcdc_primou_lg") && is_lg_panel()) {
		return 0;
	}
	return 0;
}
...
int __init primou_init_panel(void)
{
	...
	msm_fb_add_devices(primou_fb_devices, ARRAY_SIZE(primou_fb_devices));

	if (is_lg_panel()) {
		ret = platform_device_register(&lcdc_primou_lg_panel_device);
